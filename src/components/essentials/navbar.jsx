...
const navItems = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { name: 'Building Mosque', path: '/projects/project-single' },
      { name: 'Orphan Sponsoring', path: '/projects/project-single' },
      { name: 'Food Pack Distribution', path: '/projects/project-single' },
      { name: 'Qurbani Project', path: '/projects/project-single' },
      { name: 'Zakaat Project', path: '/projects/project-single' },
      { name: 'Education Sponsoring', path: '/projects/project-single' },
      { name: 'Building Orphan Housing', path: '/projects/project-single' },
      { name: 'Building Madrasah', path: '/projects/project-single' },
    ],
  },
